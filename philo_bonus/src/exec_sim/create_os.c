...
/*   Updated: 2025/03/13 06:35:39 by akyoshid         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../inc/philo_bonus.h"

int	_create_philo_death_checker(t_sim_data *sim_data, t_os_data *os_data)
{
	int	i;
...
{
	if (_create_philo_death_checker(sim_data, os_data) != 0)
		return (1);
